...
unused_macros(_) ->
    ...
    [#{file := "double.erl",
     ...
     #{file := "ignore.erl",
       line := 19,
       text := <<"?MACRO_0 is unused">>},
     #{file := "ignore.erl",
       line := 21,
       text := <<"?MACRO_0/1 is unused">>},
     #{file := "ignore.erl",
       line := 22,
       text := <<"?MACRO_0/2 is unused">>},
     #{file := "ignore.erl",
       line := 24,
       text := <<"?MACRO_1 is unused">>},
     #{file := "ignore.erl",
       line := 25,
       text := <<"?MACRO_1/0 is unused">>},
     #{file := "ignore.erl",
       line := 27,
       text := <<"?MACRO_1/2 is unused">>},
     #{file := "ignore.erl",
       line := 30,
       text := <<"?MACRO_NONE/0 is unused">>},
     #{file := "ignore.erl",
       line := 31,
       text := <<"?MACRO_NONE/1 is unused">>},
     #{file := "ignore.erl",
       line := 32,
       text := <<"?MACRO_NONE/2 is unused">>},
